...
import { Zap, Plus, Eye, EyeOff, Loader2, X, LogOut } from "lucide-react";
import toast from "react-hot-toast";
import { authApi, usersApi } from "@/api/services";
import { useAuthStore, useThemeStore, useRole } from "@/store/auth";
    ...
    <div className="space-y-4 max-w-2xl">
      ...
      {tab === "profile" && (
        <div className="card space-y-4">
          ...
          >
            <div
              className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-blue-600 flex items-center
          ...
          >
            ...
            {/* Theme toggle */}
            <div
              className="flex items-center justify-between py-3 px-0.5 border-t border-b"
              style={{ borderColor: "var(--color-border)" }}
            >
              <div>
                <div
          ...
          <div
            className="pt-4 border-t lg:hidden"
            style={{ borderColor: "var(--color-border)" }}
          >
            <button
        ...
        <div className="card space-y-4">
          ...
          >
            <div>
              ...
              <input
                {...pwdForm.register("current_password", { required: true })}
                type="password"
                className="input"
              />
            </div>
